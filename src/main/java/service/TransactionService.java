...
public interface TransactionService {
     ...
     * @throws NoSuchAccountException Thrown when either sender or recipient doesn't exist
     * @throws InsufficientBalanceException Thrown when sender doesn't have sufficient amount of money in the account
     */
    void processTransaction(Transaction transaction) throws NoSuchAccountException, InsufficientBalanceException, FailedTransactionException;
}
